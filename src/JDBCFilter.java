...
public class JDBCFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (this.needJDBC(req)) {
            ...
            try {
            	System.out.println("inside try in JDBC");
                // Create a Connection.
                conn = ConnectionUtils.getConnection();
                // Set outo commit to false.
                conn.setAutoCommit(false);
                
                System.out.println("inside try after conn in JDBC");
 
                // Store Connection object in attribute of request.
                MyUtils.storeConnection(request, conn);
                
                System.out.println("inside try store conn in JDBC");
                ...
                System.out.println("finish try in JDBC");
            } catch (Exception e) {
                e.printStackTrace();
